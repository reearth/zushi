...
// shared across all plugins; pass it to `quickjs({ module })` and each plugin
// gets its own VM context.
export const quickjsModule = newQuickJSWASMModuleFromVariant(variant);
